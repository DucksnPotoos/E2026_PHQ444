...
\]
Concentrons nous sur la dérivée. Nous obtenons pour l'énergie de Fermi :
\[
    \pdv{\epsilon_{F}}{V} &= c\hbar\qty(\frac{6\pi^2N}{g})^{1/3} \pdv{V}\frac{1}{V^{1/3}} \notag \\
    &= c\hbar\qty(\frac{6\pi^2N}{Vg})^{1/3} \frac{-1}{3V} \notag \\
    &= \frac{-\epsilon_{F}}{3V}. 
\]

Puisque $\epsilon_F$ et $\epsilon_{\lambda}$ ont tous les deux la même dépendance en volume, nous pouvons affirmer que 
\[
    \pdv{\epsilon_{\lambda}}{V} = \frac{-\epsilon_{\lambda}}{3V}.
\]
...
\solution{1.4}{\chi = \frac{6\mu_B^2}{\varepsilon_F}n}
\clearpage
