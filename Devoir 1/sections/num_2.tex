...
\[
    ...
    &= \frac{1}{V} \sum_r \frac{e^{-\beta\epsilon_r}}{Z} \notag \\
    \intertext{On sait que $P_r = \sum_r \frac{e^{-\beta\epsilon_r}}{Z}$. On remplaçe pour trouver:}
...
\question{Montrez que $\overline{\epsilon} = -V\vb{M}\vb{B}$.}
